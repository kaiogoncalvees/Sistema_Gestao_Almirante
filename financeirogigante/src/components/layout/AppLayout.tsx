  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <nav className="md:hidden border-t border-border bg-card animate-fade-in">
            <div className="px-4 py-2 space-y-1">
              ...
              <button
                ...
                className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-danger hover:bg-danger-light w-full min-h-[48px]"
              >
      ...
      <aside className="hidden md:flex fixed left-0 top-0 h-screen w-20 bg-card border-r border-border flex-col items-center py-6 z-40">
        ...
        <button
          onClick={handleSignOut}
          className="w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-200 hover:bg-danger-light group"
          title="Sair"
        >
          <LogOut className="w-5 h-5 text-muted-foreground group-hover:text-danger" />
        </button>
      </aside>
